...
<body class="bod">
<form action="Addimage" method="post" id="MyForm" enctype="multipart/form-data">
 <br>
  <h1 id="h1"><strong>UPLOAD FILES</strong></h1>
   <br>
 <h2 id="h2"><strong>IMAGES</strong></h2>
  <br>
 ...
 <br>
  ...
  <br>       
        <div class="form-group file-area" id="image">
              <label for="images">Images <span class="span">Your images should be at JPEG or PNG file</span></label>
          <input type="file" name="images" id="images" accept="image/png, image/jpeg" required="required" />
  ...
  <br>
    ...
    {
 	   %>
 	   <script>alert("your file not uploaded please check the details");</script>
 	    	   <% 
    }
%>    
  </form> 
